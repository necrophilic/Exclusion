...
#Usage
#[!] EasyFilter 1.0 by Alemalakra, Rewritten by Transmissional
...
if len(sys.argv) < 2:
    print '[!] EasyFilter 1.0 by Alemalakra, Rewritten by Transmissional'
...
# PayLoads, Thanks Zach For Payload Implementation
chargen = 'A'#lemalakra
...
proto = sys.argv[3]
size = int(sys.argv[4])  # Zach added ports too cos he is a real nig nog
syntax = sys.argv[5]
